    ...
    for w_ar in weights_ar:
        for w_vol in weights_vol:
            for w_iota in weights_iota:
                ...
                file_identifier = f"rotated_poincare_optimize_QA_wqs{w_qs}_war{w_ar}_wvol{w_vol}_wiota{w_iota}"

                if os.path.exists(f"./scan_rotated_QA/eqfam_{file_identifier}.h5"):
                    print(
...
#SBATCH -o ./scan_rotated_QA/slurm_{file_identifier}.out

module purge
module load anaconda3/2024.10
conda activate desc-env

python  run_qa_rotated_weights.py {w_qs} {w_ar} {w_vol} {w_iota}
"""
