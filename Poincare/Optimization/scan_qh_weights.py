...
for w_qs in weights_qs:
    for w_ar in weights_ar:
        for w_vol in weights_vol:
            ...
            file_identifier = f"poincare_optimize_QH_{job_name}"

            if os.path.exists(f"./scan_results_QH/eqfam_{file_identifier}.h5"):
                print(
...
#SBATCH -o ./scan_results_QH/slurm_{file_identifier}.out
