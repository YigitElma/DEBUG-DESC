...
plt.savefig(f"./scan_results_QH/boozer_{file_identifier}.png", dpi=300)
...
plt.savefig(f"./scan_results_QH/surfaces_{file_identifier}.png", dpi=500)

fig, ax = plot_1d(eqfam[-1], "iota", label="Poincare Optimized", color="blue")
plot_1d(eq00, "iota", ax=ax, label="precise_QH", color="red")
plt.legend()
plt.savefig(f"./scan_results_QH/iota_{file_identifier}.png", dpi=300)

plot_section(eqfam[-1], "|F|_normalized", log=True)
plt.savefig(f"./scan_results_QH/force_{file_identifier}.png", dpi=500)

eqfam.save(f"./scan_results_QH/eqfam_{file_identifier}.h5")
