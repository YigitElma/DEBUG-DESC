...
name = f"2coil-R0-{R0}-B0-{B0}-rmaj-{rmaj}-rmin-{rmin}-Ip-{plasma_coil.current}"
...
for Ic in [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000]:
    ...
    umbilic_coil2 = get_umbilic_coil(I=Ic, rmaj=rmaj, rmin=rmin, helical_offset=jnp.pi)
...
def plot_iotas(data):
    ...
    plt.xlabel("R (m)")
    plt.ylabel("|Iota|")
    plt.title("Ip=14kA, B0=0.35T, 2 Umbilic Coil")
    plt.legend()
